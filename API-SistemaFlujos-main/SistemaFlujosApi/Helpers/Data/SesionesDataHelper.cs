...
{
    public class SesionesDataHelper
    {
        public SistemaFlujosContext _DbContext;
        public SesionesDataHelper(SistemaFlujosContext dbContext)
        {
            _DbContext = dbContext;
        }
        public SesionesDataHelper()
        {
        ...
        public Response Add(Sesione oSesione)
        {
            ...
            try
            {
                var resultAdd = _DbContext.Sesiones.Add(oSesione);
                if (resultAdd != null)
                {
        ...
        public Response Delete(int id)
        {
            ...
            try
            {
                Sesione resultDelete = _DbContext.Sesiones.FirstOrDefault(x => x.IdSesion == id);
                ...
                else
                {
                    oResponse.code = (int)StatusResponse.Warning;
                    oResponse.message = StatusResponse.Warning.ToString();
                    oResponse.result = "No se elimino el Sesione";
                }
            }
            catch (Exception ex)
            {
        ...
        public Response Get(int id)
        {
            ...
            try
            {
                Sesione resultGet = _DbContext.Sesiones.FirstOrDefault(x => x.IdSesion == id); ;
                ...
                else
                {
                    oResponse.code = (int)StatusResponse.Warning;
                    oResponse.message = StatusResponse.Warning.ToString();
                    oResponse.result = "No existe el Sesione";
                }
            }
            catch (Exception ex)
            {
        ...
        public Response Get()
        {
            ...
            try
            {
                List<Sesione> resultGet = _DbContext.Sesiones.ToList();
        ...
        public Response Update(Sesione oSesione)
        {
            ...
            try
            {
                var resultUpdate = _DbContext.Sesiones.Update(oSesione);
